...
void drawHline(uint16_t xStart, uint16_t yStart, uint16_t Lenght, uint16_t Color);
void drawVline(uint16_t xStart, uint16_t yStart, uint16_t Lenght, uint16_t Color);
