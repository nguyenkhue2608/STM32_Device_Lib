...
void GLCD_startline(unsigned char offset)
		{
			...
			GLCD_RS=0;
			GLCD_RW=0;
			GLCD_DATA=GLCD_statline+offset;
			GLCD_EN=1;
			GLCD_delay();
			GLCD_EN=0;
		}
