/**
 * @file    rc522_simple.h
 * @brief   MFRC522 RFID reader - simple global-config variant (no device handle).
 *
 * Requires: SPI + CS hardcoded in this header (edit `hspi1`, MFRC522_CS_PORT/PIN). Same MFRC522_* names as rfid/rc522/ - do not link both in one build.
 *
 * Usage:
 *   MFRC522_Init();
 *   uint8_t str[MAX_LEN];
 *   if (MFRC522_Request(PICC_REQIDL, str) == MI_OK &&
 *       MFRC522_Anticoll(str) == MI_OK) { ... str[0..4] = UID ... }
 *
 * @author  Khue Nguyen
 * @website khuenguyencreator.com
 * @youtube https://www.youtube.com/channel/UCt8cFnPOaHrQXWmVkk-lfvg
 */
#ifndef __RC522_SIMPLE_H
#define __RC522_SIMPLE_H
